...
function getCurrentProductInfo() {
  ...
  if (!id) return {};
  const title =
    document.querySelector("h2.text-2xl.font-black")?.innerText || "";
  const loc =
    document
...
function hasSavedItem(listType, item) {
  ...
  if (item.id) {
    ...
    return (savedItemState[listType] || []).some(
      (x) => getSavedItemKey(x) === key,
    );
  }
}
...
function renderFlightSavedDrawer() {
  ...
  const total =
    (savedItemState.cart?.length || 0) + (savedItemState.wishlist?.length || 0);
  if (countEl) {
  ...
  tabs.forEach((btn) => {
    const active =
      btn.getAttribute("data-flight-saved-tab") === tourSavedDrawerTab;
  ...
  const items = Array.isArray(savedItemState[tourSavedDrawerTab])
    ? savedItemState[tourSavedDrawerTab]
    : [];
  listEl.innerHTML = "";
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  if (locEl)
    locEl.innerHTML = `<i class="fa-solid fa-location-dot"></i> ${loc}`;
  ...
  document.getElementById("productPrice").innerText =
    purePrice.toLocaleString();
  const adultPriceText = document
    .querySelector("#adultQty")
    ?.parentElement?.previousElementSibling?.querySelector("p.text-gray-400");
  const childPriceText = document
    .querySelector("#childQty")
    ?.parentElement?.previousElementSibling?.querySelector("p.text-gray-400");
  if (adultPriceText)
    adultPriceText.innerText = `${PRICES.adult.toLocaleString()}원`;
  if (childPriceText)
    childPriceText.innerText = `${PRICES.child.toLocaleString()}원`;
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: "2024-05-20",
        text: "가족들과 다녀왔는데 리조트 수영장이 정말 좋았어요.",
      },
      {
        author: "망고귀신",
        rating: 5,
        date: "2024-05-15",
        text: "호이안 야경은 정말 예술입니다. 사진 1000장 찍었네요.",
      },
      {
        author: "휴양중독",
        rating: 4,
        date: "2024-04-30",
        text: "음식이 입에 잘 맞아서 부모님도 만족해하셨습니다.",
      },
      {
        author: "베트남러버",
        rating: 5,
        date: "2024-04-12",
        text: "가이드분이 너무 친절해서 이동하는 내내 즐거웠어요.",
      },
      {
        author: "미케비치팬",
        rating: 5,
        date: "2024-03-25",
        text: "조식이 정말 맛있습니다. 리조트 선택이 신의 한 수!",
      },
      {
        author: "리얼후기",
        rating: 4,
        date: "2024-02-10",
        text: "습하긴 했지만 마사지가 포함되어 있어 피로가 싹 풀렸어요.",
      },
    ],
  },
  "교토 감성 4일 #가이세키 #온천 료칸": {
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: "2024-05-18",
        text: "료칸 온천이 너무 깨끗하고 가이세키가 정말 고급스러웠어요.",
      },
      {
        author: "온천마니아",
        rating: 5,
        date: "2024-05-02",
        text: "부모님 효도 관광으로 최고입니다. 조용하고 한적해서 좋았어요.",
      },
      {
        author: "가을감성",
        rating: 4,
        date: "2024-04-20",
        text: "아라시야마 대나무숲 산책이 기억에 많이 남네요.",
      },
      {
        author: "맛객",
        rating: 5,
        date: "2024-03-15",
        text: "일본 음식을 제대로 경험할 수 있는 구성이었습니다.",
      },
      {
        author: "뚜벅이탈출",
        rating: 5,
        date: "2024-02-28",
        text: "교토는 이동이 힘든데 패키지로 오니 몸이 너무 편해요.",
      },
    ],
  },
  "런던 완전정복 9일 #뮤지컬 #시내호텔": {
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: "2024-05-11",
        text: "호텔 위치가 너무 좋아서 저녁마다 야경 보러 나갔어요.",
      },
      {
        author: "뮤지컬덕후",
        rating: 5,
        date: "2024-04-25",
        text: "위키드 공연 봤는데 좌석도 좋고 소름 돋는 무대였습니다.",
      },
      {
        author: "박물관덕이",
        rating: 4,
        date: "2024-04-10",
        text: "가이드님 설명 없었으면 그냥 돌덩이만 보고 올 뻔했네요.",
      },
      {
        author: "영국신사",
        rating: 5,
        date: "2024-03-22",
        text: "런던 아이에서 본 풍경은 잊을 수 없는 추억입니다.",
      },
      {
        author: "티타임",
        rating: 5,
        date: "2024-03-05",
        text: "애프터눈 티 세트 체험도 정말 우아하고 좋았어요.",
      },
      {
        author: "유럽여행",
        rating: 4,
        date: "2024-02-18",
        text: "물가가 비싸지만 패키지 포함 사항이 많아 가성비 좋았습니다.",
      },
    ],
  },
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: "2024-05-14",
        text: "매일 받는 전신 마사지 덕분에 부모님이 정말 행복해하셨어요.",
      },
      {
        author: "태국요리사",
        rating: 5,
        date: "2024-04-30",
        text: "푸드코트 투어랑 야시장 방문이 정말 재밌었습니다.",
      },
      {
        author: "파타야해변",
        rating: 4,
        date: "2024-04-15",
        text: "해양 스포츠 옵션도 다양해서 친구들이랑 신나게 놀았네요.",
      },
      {
        author: "호캉스족",
        rating: 5,
        date: "2024-03-28",
        text: "호텔 수영장이 넓고 조식 종류가 엄청 많아서 좋았습니다.",
      },
      {
        author: "코끼리",
        rating: 5,
        date: "2024-02-20",
        text: "방콕 왕궁의 화려함에 압도당했습니다. 꼭 가보세요!",
      },
    ],
  },
  "허니문 럭셔리 5일 #프라이빗 빌라": {
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: "2024-05-22",
        text: "말 그대로 천국입니다. 서비스가 너무 세심해서 감동했어요.",
      },
      {
        author: "물치광이",
        rating: 5,
        date: "2024-05-08",
        text: "방 바로 밑에 상어랑 물고기들이 지나다녀요. 환상적입니다.",
      },
      {
        author: "허니문러버",
        rating: 5,
        date: "2024-04-18",
        text: "선셋 크루즈에서 마신 샴페인 맛을 잊을 수가 없네요.",
      },
      {
        author: "올인클루시브",
        rating: 4,
        date: "2024-04-02",
        text: "삼시세끼 다 맛있고 칵테일도 마음껏 마셨습니다.",
      },
      {
        author: "바다의왕자",
        rating: 5,
        date: "2024-03-15",
        text: "프라이빗 빌라라 누구의 방해도 받지 않고 쉬었습니다.",
      },
    ],
  },
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: "2024-05-10",
        text: "오로라 지수가 높아서 정말 선명하게 보고 왔습니다. 감동!",
      },
      {
        author: "얼음왕국",
        rating: 5,
        date: "2024-04-20",
        text: "빙하 트레킹은 힘들었지만 위에서 본 풍경은 경이로웠어요.",
      },
      {
        author: "블루라군",
        rating: 4,
        date: "2024-04-05",
        text: "따뜻한 온천물에 몸을 녹이니 피로가 싹 가시더라고요.",
      },
      {
        author: "아이슬러",
        rating: 5,
        date: "2024-03-12",
        text: "지구가 아닌 다른 행성에 와 있는 기분이었습니다.",
      },
      {
        author: "꿈의여행",
        rating: 5,
        date: "2024-02-25",
        text: "비용은 비싸지만 그만큼 가치가 충분한 여행이었습니다.",
      },
    ],
  },
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: "2024-05-16",
        text: "에그타르트 진짜 맛있어요. 1인 5개는 먹어야 합니다.",
      },
      {
        author: "트램중독",
        rating: 5,
        date: "2024-05-01",
        text: "좁은 골목을 올라가는 트램 안에서 본 리스본은 최고였어요.",
      },
      {
        author: "감성사진가",
        rating: 4,
        date: "2024-04-14",
        text: "타일 벽들이 너무 예뻐서 셔터를 쉴 수가 없었습니다.",
      },
      {
        author: "파두공연",
        rating: 5,
        date: "2024-03-28",
        text: "파두 공연 보는데 왜 눈물이 나죠? 정말 뭉클한 경험이었어요.",
      },
      {
        author: "대항해시대",
        rating: 5,
        date: "2024-03-02",
        text: "벨렘탑과 발견기념비에서 본 노을이 아주 멋집니다.",
      },
    ],
  },
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: "2024-05-13",
        text: "피라미드 크기에 압도당했습니다. 직접 봐야 알아요.",
      },
      {
        author: "크루즈여행",
        rating: 5,
        date: "2024-04-29",
        text: "나일강 위에서 보는 일출과 일몰은 정말 비현실적입니다.",
      },
      {
        author: "역사덕후",
        rating: 5,
        date: "2024-04-12",
        text: "가이드님 설명이 너무 좋아서 지루할 틈이 없었네요.",
      },
      {
        author: "이집트왕",
        rating: 4,
        date: "2024-03-25",
        text: "모래바람은 힘들었지만 신전들의 웅장함이 압승입니다.",
      },
      {
        author: "아부심벨",
        rating: 5,
        date: "2024-03-01",
        text: "아부심벨 신전은 꼭 가야 합니다. 패키지 동선이 좋았어요.",
      },
    ],
  },
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: "2024-05-19",
        text: "우피치 미술관 가이드 투어 덕분에 르네상스를 이해하게 됐어요.",
      },
      {
        author: "바티칸",
        rating: 5,
        date: "2024-05-04",
        text: "줄 안 서고 바티칸 들어가는 게 얼마나 큰 행복인지 알았습니다.",
      },
      {
        author: "젤라또",
        rating: 4,
        date: "2024-04-22",
        text: "로마 시내 투어 때 먹은 젤라또 맛이 아직도 생각나요.",
      },
      {
        author: "물의도시",
        rating: 5,
        date: "2024-04-10",
        text: "곤돌라 타고 운하를 지나는데 영화 속 한 장면 같았습니다.",
      },
      {
        author: "정통코스",
        rating: 5,
        date: "2024-03-18",
        text: "이동 수단이 편해서 부모님도 지치지 않고 즐거워하셨어요.",
      },
    ],
  },
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: "2024-05-17",
        text: "사그라다 파밀리아 성당은 정말 전율이 돋는 건축물이었습니다.",
      },
      {
        author: "빠에야",
        rating: 5,
        date: "2024-05-02",
        text: "음식이 다 너무 맛있어요! 특히 츄러스랑 빠에야는 최고.",
      },
      {
        author: "세비야",
        rating: 4,
        date: "2024-04-18",
        text: "플라멩코 공연의 에너지가 대단했습니다. 꼭 관람하세요.",
      },
      {
        author: "스페인여행",
        rating: 5,
        date: "2024-04-01",
        text: "가이드분이 현지 맛집을 많이 알려주셔서 자유시간도 알찼어요.",
      },
      {
        author: "태양의나라",
        rating: 5,
        date: "2024-03-12",
        text: "그라나다 알람브라 궁전의 정원이 너무 평화롭고 좋았습니다.",
      },
    ],
  },
  "타이베이 먹방 4일 #지우펀 #야시장": {
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: "2024-05-21",
        text: "야시장에서 지파이랑 망고빙수 먹은 게 제일 기억에 남아요.",
      },
      {
        author: "지우펀홍등",
        rating: 5,
        date: "2024-05-06",
        text: "밤에 켜진 홍등이 너무 예뻐요. 사람이 많지만 꼭 가보세요.",
      },
      {
        author: "딤섬매니아",
        rating: 4,
        date: "2024-04-24",
        text: "딘타이펑 샤오롱바오는 한국에서 먹는 거랑 차원이 다릅니다.",
      },
      {
        author: "대만친구",
        rating: 5,
        date: "2024-04-11",
        text: "가이드분이 재밌으셔서 이동하는 버스 안이 항상 화기애애했어요.",
      },
      {
        author: "짧은휴가",
        rating: 5,
        date: "2024-03-29",
        text: "주말 끼고 다녀오기 딱 좋은 코스입니다. 가성비 최고!",
      },
    ],
  },
  "하와이 휴양 6일 #와이키키 #스노클링": {
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: "2024-05-15",
        text: "하나우마 베이에서 본 거북이가 아직도 눈에 선합니다.",
      },
      {
        author: "와이키키",
        rating: 5,
        date: "2024-04-28",
        text: "쇼핑몰도 가깝고 바다도 가까워서 호텔 위치가 정말 환상이었어요.",
      },
      {
        author: "하와이안",
        rating: 4,
        date: "2024-04-12",
        text: "새우 트럭 갈릭 새우 꼭 드세요. 두 번 드세요!",
      },
      {
        author: "신혼느낌",
        rating: 5,
        date: "2024-03-25",
        text: "결혼 10주년으로 갔는데 다시 신혼으로 돌아간 기분이었습니다.",
      },
      {
        author: "쇼핑왕",
        rating: 5,
        date: "2024-03-08",
        text: "아울렛 투어 시간이 넉넉해서 득템 많이 하고 왔습니다.",
      },
      {
        author: "서핑러",
        rating: 5,
        date: "2023-12-15",
        text: "서핑 강습도 연결해주셔서 버킷리스트 하나 이뤘네요.",
      },
    ],
  },
};
...
function updateProductInfo(title, id) {
  ...
  const childQtyRow = document
    .getElementById("childQty")
    ?.closest(".flex.items-center.justify-between.pt-5");
  if (!descEl) return;
  ...
  if (!found) {
    descEl.innerText =
      "이 패키지 상품의 상세 정보는 준비 중입니다. 현지 파트너와의 실시간 연동을 통해 곧 상세 내용을 안내해 드리겠습니다.";
  }
}
...
function handleBooking() {
  ...
  function getBookingSnapshot() {
    return {
      ...
      totalText:
        document.getElementById("totalPriceDisplay")?.innerText || "0원",
  ...
  function openPaymentStep(snapshot, traveler) {
    ...
    panel
      .querySelector("[data-tour-checkout-close]")
      ?.addEventListener("click", closeCheckoutModal);
    panel
      .querySelector("#tourPayNowBtn")
      ?.addEventListener("click", async function () {
        ...
        try {
          const amount =
            Number(String(snapshot.totalText || "0").replace(/[^\d]/g, "")) ||
            0;
          const payload = {
            tour: {
          ...
          if (checkout.payment_mode !== "toss" || !checkout.toss_client_key) {
            throw new Error(
              "토스 결제 설정이 없습니다. 운영자에게 TOSS 키 설정을 요청해주세요.",
            );
          }
          ...
          await toss.requestPayment("카드", {
            ...
            orderName: String(
              checkout.order_name || snapshot.product.name || "패키지 예약",
            ),
            customerName: String(
              traveler.name_kr || traveler.name_en || "",
            ).trim(),
            customerEmail: String(traveler.email || "").trim(),
            successUrl: String(
              checkout.success_url || `${location.origin}/payment/pack/success`,
            ),
            failUrl: String(
              checkout.fail_url || `${location.origin}/payment/pack/fail`,
            ),
          });
        } catch (err) {
  ...
  function openCheckoutModal(snapshot) {
    ...
    modal
      .querySelectorAll("[data-tour-checkout-close]")
      .forEach((el) => el.addEventListener("click", closeCheckoutModal));
    modal
      .querySelector("#tourCheckoutForm")
      ?.addEventListener("submit", (e) => {
        e.preventDefault();
        const traveler = Object.fromEntries(
  ...
  if (snapshot.adult === 0 && snapshot.child === 0)
    return showToast("인원을 선택해주세요.");
...
function renderInitialReviews(productKey) {
  ...
  if (reviews.length === 0) {
    reviewList.innerHTML =
      '<p class="text-center text-gray-400 py-10">아직 작성된 리뷰가 없습니다.</p>';
  ...
  function renderReviewsChunk() {
    ...
    toShow.forEach((rev, idx) => {
      const stars =
        '<i class="fa-solid fa-star text-yellow-400"></i>'.repeat(rev.rating) +
...
function submitReview() {
  ...
  newReview.className =
    "p-6 bg-blue-50/20 border border-blue-100 rounded-2xl shadow-sm";
  newReview.dataset.rating = currentRating;
  newReview.dataset.date = dateStr;
  const stars =
    '<i class="fa-solid fa-star"></i>'.repeat(currentRating) +
